  ...
  return <>
    <div className="workspace">
      <section className="panel" aria-labelledby="checkin-heading">
        ...
        <p className="muted small">Unsaved values stay only in this tab and are lost on reload. Saving again for the same date updates that day’s check-in with your latest values. Earlier revisions remain available.</p>
      </section>
