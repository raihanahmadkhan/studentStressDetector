...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main id="main">
      {user && <div className="intro"><h1>Understand your stress today.</h1><p>Estimate stress from your routine, understand its contributors, and track how you feel over time.</p></div>}
